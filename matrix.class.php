...
* Fecha de Creaci鏮: 30/sept/2005
* Diego Carrera - Kleber Ba隳
* Guayaquil - Ecuador
*
*/
class matrix {
...
/*FUNCIONES DE BASICAS DE LA CLASE MATRIX */
	...
	/**
	 * Setee el nero de filas de la matriz
	 *
	 */
	...
	/**
	 * Setee el nero de columna de la matriz
	 *
	 */	
	...
	/**
	 * Obtiene el nero de filas que tiene el objeto matriz
	 *
	 * @return integer
	 */
	...
	/**
	 * Obtiene el nero de columnas que tiene el objeto matriz
	 *
	 * @return integer
	 */
	...
	/**
	 * Obtiene el nero de filas que tiene un Arreglo de una matriz
	 *
	...
	/**
	 * Obtiene el nero de columnas que tiene un arreglo de una matriz
	 *
	 * @param ArrayData $ArrayDataMatriz
	 * @return integer
	 */
...
/*FUNCIONES DE VALIDACIONES DE MATRICES */
	...
	/**
	 * Dado un arreglo de datos de una matriz, valida que el nero de 
...
/*FUNCIONES DE OPERACIONES BASICAS CON MATRICES */
	 ...
	 * Requisito: Todas filas deben tener el mismo nero de columnas.
